...
from model_training_lgb import *
...
def predict(json_input_path, *args):
    ...
    clf_lgb = lgb.Booster(model_file="models/trained_model_lgb.bin")
    print("Pre-trained model loaded successfully.")

    # load RFEfeatures
    print("Loading RFE features from training_features...")
    directory = "./training_features"
    path = os.path.join(directory, "RFEfeatures_lgb.json")
    with open(path) as f:
    ...
    score = clf_lgb.predict(X[predictive_features])
    ...
    if args:
        ...
        print("-----Performance Report of LGBM-----:")
